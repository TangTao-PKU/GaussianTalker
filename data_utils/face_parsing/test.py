...
l_color = [[255, 255, 255],
           ...
           [0, 0, 128],
           [128, 0, 0], [255, 255, 128], [128, 255, 255],
           [192, 128, 192], [128, 255, 128],
           [128,128, 255],
           [255, 128, 128], [165, 42, 42], [192, 192, 192]]
...
def vis_parsing_maps(im, parsing_anno, stride, save_im=False, save_path='vis_results/parsing_map_on_im.jpg',
    ...
    for pi in range(17, num_of_class+1):
        index = np.where(vis_parsing_anno == pi)
        if args.parse_hair:
            vis_parsing_anno_color[index[0], index[1], :] = np.array([60, 179, 113])
        else:
            vis_parsing_anno_color[index[0], index[1], :] = np.array([255, 0, 0])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--parse_hair', action="store_true")
